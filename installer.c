...
char argc, *argv[];
{
	...
	printf("PREDICT appears to be installed under %s/\n",pwd);
	...
	printf("File predict.h was successfully created!\n");
	printf("Now compiling PREDICT...\n");
	...
	if (cc==0)
	{
		printf("Linking PREDICT binaries to %s\n",destination);
